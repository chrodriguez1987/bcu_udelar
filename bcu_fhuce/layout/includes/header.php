...
<header id="page-header-wrapper" <?php if($fixedheader) { ?> style="position: fixed;" <?php } ?>>
                ...
                <?php } else { ?>
                    <div class="dropdown secondone">
                        ...
                        <ul class="dropdown-menu usermen" role="menu">
                            ...
                            <?php } ?>
                                <li><a href="<?php p($CFG->wwwroot) ?>/user/preferences.php" title="Preferences"><i class="fa fa-user-secret"></i>Preferencias</a></li>
    ...
    <div id="page-header" class="clearfix container">
        <?php if ($haslogo) { ?>
            <a href="http://eva.universidad.edu.uy"><?php echo "<img src='http://164.73.2.138/permalinks/eva/LOGOS_UdelarProEVA.svg' alt='logo' id='logo' />"; echo "</a>";
        } else { ?>
            <a href="http://eva.universidad.edu.uy"><img src="http://164.73.2.138/permalinks/eva/LOGOS_UdelarProEVA.svg" id="logo"></a>
        <?php } ?>
