...
// MENU EVA FIJO
                ...
                $branchurl   = new moodle_url('http://eva.universidad.edu.uy');
                $branchsort  = 9990;
                $branch = $menu->add($branchlabel, $branchurl, $branchtitle, $branchsort);
                $branchtitle0 = 'EVA FCEA';
                $branchlabel0 = '<i class="fa fa-home"></i> '.$branchtitle0;
                $branchurl0   = new moodle_url('/');
                $branchsort0  = 9992;
                $branch->add($branchlabel0, $branchurl0, $branchtitle0, $branchsort0);
                $branchtitle1 = 'Pro Eva';
                $branchlabel1 = '<i class="fa fa-university"></i> '.$branchtitle1;
                $branchurl1   = new moodle_url('http://eva.universidad.edu.uy');
                $branchsort1  = 9993;
                $branch->add($branchlabel1, $branchurl1, $branchtitle1, $branchsort1);
                $branchtitle2 = ' Área de Tecnologías y Ciencias de la Naturaleza y el Hábitat';
                $branchlabel2 = '<i class="fa fa-cubes"></i> '.$branchtitle2;
                $branchurl2   = new moodle_url('http://eva.universidad.edu.uy/course/index.php?categoryid=19');
                $branchsort2  = 9995;
                $branch->add($branchlabel2, $branchurl2, $branchtitle2, $branchsort2);
                $branchtitle3 = 'Área Ciencias de la Salud';
                $branchlabel3 = '<i class="fa fa-cubes"></i> '.$branchtitle3;
                $branchurl3   = new moodle_url('http://eva.universidad.edu.uy/course/index.php?categoryid=20');
                $branchsort3  = 9996;
                $branch->add($branchlabel3, $branchurl3, $branchtitle3, $branchsort3);
                $branchtitle4 = 'Área Ciencias Sociales y Artística';
                $branchlabel4 = '<i class="fa fa-cubes"></i> '.$branchtitle4;
                $branchurl4   = new moodle_url('http://eva.universidad.edu.uy/course/index.php?categoryid=18');
                $branchsort4  = 9997;
                $branch->add($branchlabel4, $branchurl4, $branchtitle4, $branchsort4);
                $branchtitle5 = 'Interior';
                $branchlabel5 = '<i class="fa fa-cubes"></i> '.$branchtitle5;
                $branchurl5   = new moodle_url('http://eva.universidad.edu.uy/course/index.php?categoryid=23');
                $branchsort5  = 9998;
                $branch->add($branchlabel5, $branchurl5, $branchtitle5, $branchsort5);
                $branchtitle6  = 'Educación Permanente';
                $branchlabel6 = '<i class="fa fa-cube"></i> '.$branchtitle6;
                $branchurl6   = new moodle_url('http://eva.universidad.edu.uy/course/index.php?categoryid=491');
                $branchsort6  = 9999;
                $branch->add($branchlabel6, $branchurl6, $branchtitle6, $branchsort6);
                $branchtitle7 = 'Funciones Universitarias, Programas Centrales e Interdisciplinarios';
                $branchlabel7 = '<i class="fa fa-cube"></i> '.$branchtitle7;
                $branchurl7   = new moodle_url('http://eva.universidad.edu.uy/course/index.php?categoryid=516');
                $branchsort7  = 10000;
                $branch->add($branchlabel7, $branchurl7, $branchtitle7, $branchsort7);
...
if (!isloggedin() || isguestuser()){
                ...
                $branchsort  = 9993;
                $branch = $menu->add($branchlabel, $branchurl, $branchtitle, $branchsort);
                $branchtitle1 = 'Crear Usuario';
                $branchlabel1 = '<i class="fa fa-user-plus"></i> '.$branchtitle1;
                $branchurl1   = new moodle_url('http://eva.fcea.edu.uy/mod/page/view.php?id=4090');
                $branchsort1  = 9994;
                $branch->add($branchlabel1, $branchurl1, $branchtitle1, $branchsort1);
                $branchtitle2 = 'Recuperar contraseña';
                $branchlabel2 = '<i class="fa fa-unlock"></i> '.$branchtitle2;
                $branchurl2   = new moodle_url('/login/forgot_password.php');
                $branchsort2  = 9995;
                $branch->add($branchlabel2, $branchurl2, $branchtitle2, $branchsort2);
...
// Menu Mis Sitios            
            ...
            if (!empty($PAGE->theme->settings->enablemysites)) {
                ...
                $branchlabel = '<i class="fa fa-graduation-cap"></i><span class="menutitle">'.$branchtitle.'</span>';
...
// Menu ayuda, tanto como logueado como no logueado
...
// Menu Servicio  modificar dependiendo del servicio
    ...
    public function tools_menu() {
        ...
        if (!empty($PAGE->theme->settings->toolsmenu)) {
            ...
            $custommenuitems .= "<i class='fa fa-plus'> </i>EVA FCEA"."|#|"."EVA FCEA\n";
